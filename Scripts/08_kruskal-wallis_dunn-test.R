...
if (FLAG_BG == 0) {
  ...
  IN_FOLD <- "/crex1/proj/uppstore2017185/b2014034_nobackup/Luis/3_DosageCompensation_LS/NEW_10_filter_sex_biased_genes_sva_75perc_m-f"          
  #IN_FOLDER <- "/crex1/proj/uppstore2017185/b2014034_nobackup/Luis/3_DosageCompensation_LS/NEW_16_Assign_to_chromosomes_m_vs_f_SBG"           # after removing SBG, quantile normalized libraries
}
...
if (FLAG_BG == 0) {
  ...
  results_dir <- "/crex1/proj/uppstore2017185/b2014034_nobackup/Luis/3_DosageCompensation_LS/NEW_06_dosage_compensation_a_vs_z_AFTER_REMOVE_SEX_BIASED_GENES_sva_75perc_m-f"     
  #OUT_FOLDER <- "/crex1/proj/uppstore2017185/b2014034_nobackup/Luis/3_DosageCompensation_LS/NEW_18_kruskal-wallis_dunn_AFTER_REMOVE_SEX_BIASED_GENES_sva_75perc_m-f"
}
