...
plot(plot_instar_V_a, lwd = 3, ylim = c(0, 0.7), xlim = c(-10, 10), col = "grey", 
     xlab = "", main = "Instar V", cex.main = 2, cex.lab = 1.5,
...
text(x=0.19, "*", y=0.35, pos=3, cex=2.5)
text(x=0.146, y = 0.36, '{', srt = -90, cex = 1.7)

legend(-12, -0.12, legend = "Autosomes", cex = 1.5, xpd = TRUE,
       col = "grey", bty = "n", lty = 1, lwd = 3)
legend(1, -0.12, legend = "Z", cex = 1.5, xpd = TRUE,
