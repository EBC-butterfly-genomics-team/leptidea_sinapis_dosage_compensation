...
setwd("G:/Masterarbete/Fisher_test")
...
row.names(FisherTest_table) <- c("Instar_V_female", "Pupa_female", "Adult_female",
                                 "Instar_V_male", "Pupa_male", "Adult_male")
...
text(x=0.5, y=11.2, "Instar V", cex = 1.5)
text(x=0.5, y=7.5, "Pupa", cex = 1.5)
text(x=0.5, y=4, "Adult", cex = 1.5)

legend(0.75, 1, legend = c("Female biased", "Unbiased", "Male biased"), cex = 1.2,
            pch = 22, xpd = TRUE, pt.bg = c("red", "lightgrey", "blue"),
            col = "black", bty = "n", y.intersp = 0.15, text.width = 0.05)
