...
heatscatter(instar_V_male_a, instar_V_female_a, asp = TRUE, pch = 16, cexplot = 0.8,
      ...
      ylim = c(-11,15), xlim = c(-10,15), main = "", xlab = "",
      ylab = "Female log2 FPKM(>0)", cex.lab = 1.5)
title(main = "Instar V", cex.main = 2)
...
heatscatter(pupa_male_a, pupa_female_a, asp = TRUE, pch = 16, cexplot = 0.8,
     nrcol = 5, grid = 1000, colpal = colscale[4:8],
     ylim = c(-11,15), xlim = c(-10,15), main = "",
     xlab = "", ylab = "", cex.lab = 2)
...
axis(1, labels = "Male log2 FPKM(>0)", cex.axis = 1.5, at = 2.5, line = 4, tck = 0)
...
legend(-11, -15, legend = "Autosomes", cex = 1.5, xpd = TRUE,
       col = "grey", bty = "n", pch = 19)
legend(1, -15, legend = "Z", cex = 1.5, xpd = TRUE,
